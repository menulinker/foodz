          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-foodz-100 flex items-center justify-center mb-4">
                ...
                <div className="mt-4 text-foodz-500">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-foodz-100 flex items-center justify-center mb-4">
                  <ShoppingBag className="h-8 w-8 text-foodz-500" />
                </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-foodz-100 flex items-center justify-center mb-4">
                  <CreditCard className="h-8 w-8 text-foodz-500" />
                </div>
            ...
            <div className="mx-auto max-w-5xl">
              <Carousel className="w-full">
                <CarouselContent>
                    ...
                    <Card className="border-0 shadow-lg overflow-hidden">
                      <CardContent className="p-0">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                          <div className="bg-foodz-500 p-8 flex items-center text-white">
                            <div>
                  ...
                  <CarouselItem>
                    <Card className="border-0 shadow-lg overflow-hidden">
                      <CardContent className="p-0">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                          <div className="bg-foodz-600 p-8 flex items-center text-white">
                            <div>
                  ...
                  <CarouselItem>
                    <Card className="border-0 shadow-lg overflow-hidden">
                      <CardContent className="p-0">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                          <div className="bg-foodz-700 p-8 flex items-center text-white">
                            <div>
                              <BarChart4 className="h-8 w-8 mb-4" />
                ...
                <div className="flex justify-center gap-2 mt-4">
                  <CarouselPrevious className="relative inset-0 translate-y-0 hover:bg-foodz-100 hover:text-foodz-500" />
                  <CarouselNext className="relative inset-0 translate-y-0 hover:bg-foodz-100 hover:text-foodz-500" />
                </div>
              </Carousel>
            </div>
          </div>
